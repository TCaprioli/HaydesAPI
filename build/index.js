...
var keys_config_1 = __importDefault(require("./config/keys.config"));
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, mongoose_1.default.connect(keys_config_1.default.MDB_KEY, { useNewUrlParser: true })];
            case 1:
                _a.sent();
